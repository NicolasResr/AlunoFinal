...
form.addEventListener('submit', async (event) => {
    ...
    try {
        ...
        if (alunoIdEdicao) {
            ...
            const response = await fetch('https://cadaluno.azurewebsites.net/a/pi', {
                method: 'POST',
                headers: {
...
editForm.addEventListener('submit', async (event) => {
    ...
    try {
        ...
        const response = await fetch(`https://cadaluno.azurewebsites.net/a/${alunoIdEdicao}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function listarAlunos() {
    try {
        const response = await fetch('https://cadaluno.azurewebsites.net/a');
...
function editarAluno(id) {
    ...
    fetch(`https://cadaluno.azurewebsites.net/a/${id}`)
...
async function deletarAluno(id) {
    if (confirm('Tem certeza que deseja deletar este aluno?')) {
        try {
            const response = await fetch(`https://cadaluno.azurewebsites.net/a/${id}`, {
                method: 'DELETE'
            });
